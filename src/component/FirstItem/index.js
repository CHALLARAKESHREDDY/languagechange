  ...
  const FirstItem=(props)=>{
    ...
    switch (activeLanguage){
        case "EN" :
            return(
                <div>
                    <h2>{landingSectionContent.EN.heading}</h2>
                    <p>{landingSectionContent.EN.description}</p>
                </div>
            )
        ...
        case "TE" :
                return(
                    <div>
                        <h2>{landingSectionContent.TE.heading}</h2>
                        <p>{landingSectionContent.TE.description}</p>
                    </div>
                )
        ...
        case "HI" :
                    return(
                        <div>
                            <h2>{landingSectionContent.HI.heading}</h2>
                            <p>{landingSectionContent.HI.description}</p>
                        </div>
                    )
    }
}
